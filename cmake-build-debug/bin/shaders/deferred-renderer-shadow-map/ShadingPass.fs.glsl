...
void main() {
    ...
    float dirLightVisibility = positionInDirLightNDC.z < depthBlockerInDirSpace + uDirLightShadowMapBias ? 1.0 : 0.2;

	fFragColor = blinnPhong(d, s, a, sh, pos, norm) * dirLightVisibility;
    //fFragColor = vec3(1,1,1) * dirLightVisibility;
}
